...
class PIIMasker:
    def __init__(self):
        ...
        model_path = os.path.join(current_dir, "output model", "deberta3base_1024")
        self.tokenizer = AutoTokenizer.from_pretrained(model_path)
        # Use safetensors format for model loading
        self.model = AutoModelForTokenClassification.from_pretrained(model_path, use_safetensors=True)
