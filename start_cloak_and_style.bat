...
REM Ensure PII model folders exist and download if missing
echo Checking PII models in pii-mask\pii-masker\"output model"...
python ensure_models.py
if errorlevel 1 (
    echo ERROR: Failed ensuring models. You may need internet access to download models.
    pause
    exit /b 1
)
